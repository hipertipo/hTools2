...
def print_generic_identification(font):
    ...
    print 'familyName: %s' % font.info.familyName
    print 'styleName: %s' % font.info.styleName
    print 'styleMapFamilyName: %s' % font.info.styleMapFamilyName
    print 'styleMapStyleName: %s' % font.info.styleMapStyleName
    print 'versionMajor: %s' % font.info.versionMajor
    print 'versionMinor: %s' % font.info.versionMinor
    print 'year: %s' % font.info.year
    print
