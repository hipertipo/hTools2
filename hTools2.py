...
class hSettings:
    ...
    root = '$ROOT'
    fonts_system = '$FONTS_SYSTEM'
    ftp = { 'url' : '$URL', 'login' : '$LOGIN', 'password' : '$PASSWORD', }
    ...
    def output(self):
        ...
        print '\tAdobe fonts folder: %s' % self.fonts_adobe
        print '\tFTP settings: %s' % self.ftp.keys()
        print
