...
class adjustVerticalMetrics(object):
    ...
    def __init__(self, font):
        ...
        self.w.xheight_label = TextBox(
            (self._padding,
            self._padding + (self._row * 1) + self._padding,
            -self._padding,
            30),
            "x-height")
        self.w.xheight_slider = Slider(
            (self._column_1,
            self._padding + (self._row * 1) - 5 + self._padding,
        ...
        self.w.ascender_label = TextBox(
            (self._padding,
            self._padding + (self._row * 2) + self._padding,
            -self._padding,
            30),
            "ascender")
        self.w.ascender_slider = Slider(
            (self._column_1,
            self._padding + (self._row * 2) - 5 + self._padding,
            -(self._column_3 + (self._padding*2)),
            30),
        ...
        self.w.descender_label = TextBox(
            (self._padding,
            self._padding + (self._row * 3) + self._padding,
            -self._padding,
            30),
            "descender")
        self.w.descender_slider = Slider(
            (self._column_1,
            self._padding + (self._row * 3) - 5 + self._padding,
            -(self._column_3 + (self._padding*2)),
            30),
        ...
        self.w.capheight_label = TextBox(
            (self._padding,
            self._padding + (self._row * 4) + self._padding,
            -self._padding,
            30),
            "cap-height")
        self.w.capheight_slider = Slider(
            (self._column_1,
            self._padding + (self._row * 4) - 5 + self._padding,
            -(self._column_3 + (self._padding*2)),
            30),
        ...
        self.w.units_per_em_label = TextBox(
            (self._padding,
            self._padding + (self._row * 5) + self._padding,
            -self._padding,
            30),
            "units per Em")
        self.w.units_per_em_slider = Slider(
            (self._column_1,
            self._padding + (self._row * 5) - 5 + self._padding,
            -(self._column_3 + (self._padding*2)),
            30),
