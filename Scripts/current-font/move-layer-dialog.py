...
class MoveGlyphWindow:
    ...
    def __init__(self, font):
        ...
        self.moveX = 0
        self.moveY = 0
        self.w = FloatingWindow((280, 150), "Move Glyphs")
        # target layer
        self.w.layer_label = TextBox((10, 10, -10, 17), "layer")
        self.w.layer_menu = PopUpButton((85, 10, -10, 20), self.font.layerOrder)
        # x position
        self.w.x_label = TextBox((10, 45, -10, 17), "move x")
        self.w.x_slider = Slider((85, 45, -12, 22), value=0, maxValue=200, minValue=-200, callback=self.adjust)
        # y position
        self.w.y_label = TextBox((10, 75, -10, 17), "move y")
        self.w.y_slider = Slider((85, 75, -12, 22), value=0, maxValue=200, minValue=-200, callback=self.adjust)
        # buttons
        self.w.button_apply = Button((10, -35, -10, 20), "flip background/mask layers", callback=self.flip_layers_callback)
...
OpenWindow(MoveGlyphWindow, CurrentFont())
