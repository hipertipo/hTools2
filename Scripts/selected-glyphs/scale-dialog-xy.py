...
class scaleGlyphsXYDialog(object):
    ...
    def __init__(self):
        self.w = FloatingWindow(
            ((self._button_w*3)+(self._padding*2)-2, (self._button_h*4)+(self._padding*3)-2),
            self._title)
        # xy +
        self.w._scale_minus_button_1 = SquareButton(
            (self._padding,
            self._padding,
            self._button_w,
            self._button_h),
            "XY +1%", callback=self._scale_xy_plus_1_callback)
        self.w._scale_minus_button_10 = SquareButton(
            (self._button_w+((self._padding*1)-1),
            self._padding,
            self._button_w,
            self._button_h),
            "XY +10%", callback=self._scale_xy_plus_10_callback)
        self.w._scale_minus_button_100 = SquareButton(
            ((self._button_w*2)+((self._padding*1)-2),
            self._padding,
            self._button_w,
            self._button_h),
            "XY +100%", callback=self._scale_xy_plus_100_callback)
        # xy -
        self.w._scale_plus_button_1 = SquareButton(
            (self._padding,
            self._button_h+(self._padding-1),
            self._button_w,
            self._button_h),
            "XY -1%", callback=self._scale_xy_minus_1_callback)
        self.w._scale_plus_button_10 = SquareButton(
            (self._button_w+((self._padding*1)-1),
            self._button_h+(self._padding-1),
            self._button_w,
            self._button_h),
            "XY -10%", callback=self._scale_xy_minus_10_callback)
        self.w._scale_plus_button_100 = SquareButton(
            ((self._button_w*2)+(self._padding*1)-2,
            self._button_h+(self._padding-1),
            self._button_w,
            self._button_h),
            "XY -100%", callback=self._scale_xy_minus_100_callback)
        # + 1  
        ...
        self.w._scale_plus_y_button_10 = SquareButton(
            (self._button_w + ((self._padding*1)-1) + (self._button_w/2),
            (self._button_h*2) + (self._padding*2) - 1,
            self._button_w/2,
            self._button_h),
        ...
        self.w._scale_plus_y_button_100 = SquareButton(
            ((self._button_w*2) + (self._padding*1) - 2 + (self._button_w/2),
            (self._button_h*2) + (self._padding*2) - 1,
            self._button_w/2,
            self._button_h),
        ...
        self.w._scale_minus_x_button_1 = SquareButton(
            (self._padding,
            (self._button_h*3)+(self._padding*2)-2,
            (self._button_w/2)+1,
            self._button_h),
            "X -1%", sizeStyle='small',
    ...
    def _scale_xy_minus_1_callback(self, sender):
        self.scale_glyphs((0.99, 0.99))

    def _scale_xy_minus_10_callback(self, sender):
        self.scale_glyphs((0.9, 0.9))

    def _scale_xy_minus_100_callback(self, sender):
        self.scale_glyphs((0.5, 0.5))

    def _scale_xy_plus_1_callback(self, sender):
        self.scale_glyphs((1.01, 1.01))

    def _scale_xy_plus_10_callback(self, sender):
        self.scale_glyphs((1.1, 1.1))

    def _scale_xy_plus_100_callback(self, sender):
        self.scale_glyphs((2.0, 2.0))
