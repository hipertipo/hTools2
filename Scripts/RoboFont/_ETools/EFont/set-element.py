...
import hTools2.plugins.rasterizer
reload(hTools2.plugins.rasterizer)

import hTools2.plugins.elementar
reload(hTools2.plugins.elementar)

from hTools2.plugins.rasterizer import *
...
class setElementDialog(object):
    ...
    def _set_element_callback(self, sender):
        ...
        setElement(f, _scale, type='super', magic=_super)
